...
The main semantic structure tags of HTML5 are `<section>`, `<article>`, `<nav>`. Use these semantic tags in appropriate semantic sections to replace the old semantically meaningless `<div>`.
